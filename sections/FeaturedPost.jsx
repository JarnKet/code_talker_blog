    ...
    <div className="w-full h-full flex items-center pl-4 justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full justify-items-center">
        {dataLoaded &&
          featuredPosts.map((post, index) => (
            <div className="flex item-center w-full lg:w-[300px]">
              <h1 className="font-bold text-neutral-600 dark:text-neutral-400 text-4xl mr-2">
                {index + 1}
              </h1>
        ...
        {/* <div className="flex justify-center ">
          <h1 className="font-bold text-neutral-600 dark:text-neutral-400 text-4xl mr-2">01</h1>
          <div>
            ...
            <small className="text-neutral-600 dark:text-neutral-400">10 Apr 2023</small>
          </div>
        </div>
        <div>2</div>
        <div>3</div>
