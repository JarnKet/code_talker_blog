...
const PostCard = ({ post }) => {
  return (
    <div className="flex p-4 overflow-hidden mb-8  dark:bg-neutral-900 dark:text-white  shadow-lg  flex-col lg:h-[450px] sm:w-[80%]">
      ...
      <div className="flex lg:flex-row flex-col w-full h-full gap-6 justify-center items-center">
        <div className="lg:w-[50%] w-full h-full justify-center items-center">
          <div className="relative overflow-hidden shadow-md pb-40 mb-4 w-full h-full">
            <img
              alt={post.title}
      ...
      <div className="flex w-full justify-center items-center">
        <button className="mt-4 p-4 text-white dark:text-neutral-900 font-semibold bg-neutral-900 dark:bg-white  hover:translate-y-2 transition-all duration-500    ">
